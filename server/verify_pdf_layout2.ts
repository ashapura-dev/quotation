...
async function run() {
  console.log("Generating layout verification PDF...");
  ...
  const testInput = {
    ...
    containerDetails: "1 × 20ft Standard\n1 × 40ft Standard",
    ...
    containers: [
      { containerSizeId: 1, containerSizeLabel: "20ft Standard", quantity: 1 },
  ...
  const destPath = path.join(destDir, "verify_layout_final.pdf");
